...
export const MainNav = ({ className }: React.HTMLAttributes<HTMLElement>) => {
  ...
  const routes = [
    ...
    },
    {
      ...
      active: pathname === `/${params.storeId}/sizes` ? true : false
    },
    {
      title: 'Colors',
      href: `/${params.storeId}/colors`,
      active: pathname === `/${params.storeId}/colors` ? true : false
    },
    {
      title: 'Products',
      href: `/${params.storeId}/products`,
      active: pathname === `/${params.storeId}/products` ? true : false
    },
    {
      title: 'Orders',
      href: `/${params.storeId}/orders`,
      active: pathname === `/${params.storeId}/orders` ? true : false
    },
    {
      title: 'Settings',
